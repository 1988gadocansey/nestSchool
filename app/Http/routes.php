...
Route::group(['middleware' => ['web']], function () {
 Route::auth();
    Route::get('/load/student', function () {
        return view('kojo');
    });
    Route::get('/', function () {
  ...
  Route::get('/change_password', 'PasswordController@showChange');
    ...
    Route::post('/load', 'StudentController@uploadData');
    ...
    Route::get('autocomplete', 'SearchController@index');
     Route::get('search/receipt', 'SearchController@findReceipt');
    ...
    Route::post('/bill/create', 'FeeController@store');
   ...
   /* Route::controller('/view_payments', 'PaymentController', [
    ...
    Route::post('/update/bills', 'FeeController@updateBills');
    // Academic routes
   ...
   Route::match(array("get", "post"),'/report/broadsheet', "CourseController@broadsheet");
 ...
 Route::get('/directory', 'StaffController@directory');
Route::post('/power_users', 'UserController@createStaffAccount');
//    if(date("d/m/Y")<="30/09/2017"){
//        echo "<h4 style='color:red'>FREE LICENSE EXPIRED!!! CONTACT GAD 0243348522</h4>";
//        die();
//    }
// book transactions
...
Route::post( '/system/registration/batch/process', "CourseController@processBatchRegistration");
   ...
   Route::get('/systems/user/logs','SettingsController@logs');
    ...
    Route::get('/systems/user/logs','SettingsController@logs');
    Route::get('/finance/bills/single','FeeController@showBillSignleForm');
    
     Route::post('/finance/bills/single/','FeeController@printSingleBill');
   ...
   Route::get('/finance/reports/fees/','FeeController@getIndex');
   ...
   Route::post('/finance/reports/ledger/student','ReportController@studentLedger');
    ...
    Route::get('/report/sms', 'CourseController@smsResult');
