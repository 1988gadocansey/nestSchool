...
class BankController extends Controller
{
    ...
    public function anyData(Request $request)
    {
        ...
        $banks = BankModel::select([  'id','bname', 'accountno']);
    ...
    public function update(Request $request, $id){
         $query=  BankModel::where("id",$id)->update(array("bname"=>$request->input('bank'),"accountno"=>$request->input('account')));
