         ...
         <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-2">
                            ...
                            <div class="uk-form-row">
                                <label>Role</label>
                                <p></p>
                               {!!  Form::select('role', array('Accountant'=>'Accountant','Lecturer'=>'Teacher','House Master'=>'House Master','Head Master'=>'Head Master','Class Teacher'=>'Class Teacher','top'=>'Senior Officer','House Mistress'=>'House Mistress','Liberian'=>'Liberian'), null, ['placeholder' => 'select role','class'=>'md-input','required'=>''], old("","")); !!}
 ...
 var oTable = $('#gad').DataTable({
        ...
        columns: [
          ...
          {data: 'id', name: 'users.id'},
           {data: 'emp_number', name: 'tpoly_workers.emp_number'},
