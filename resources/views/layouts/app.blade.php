...
<head>
    ...
    <title>School Resource Planning System - Nest School</title>
            ...
            <nav class="uk-navbar">
                <div class="main_logo_top">
                    <a href="/dashboard"><img src='{{url("public/assets/img/logo.PNG")}}' alt="" height="15" width="71"/></a>
                     <span class="" style="color:white"  >Nest School</span>
...
<!--                                     <p><a href='{!! url("/finance/reports/fees/") !!}'>Create  Bills</a></p>-->
                                    <p><a href='{!! url("/finance/reports/fees/") !!}'>View Bills</a></p>
                                       <p><a href='{!! url("/finance/reports/fees/") !!}'>Print Single  Bill</a></p>
                              
                                      <p><a href='{!! url("/finance/reports/fees/") !!}'>Print Bulk  Bills</a></p>
                                </div>
                                <h3 class="uk-accordion-title">Summarized Reports</h3>
                                <div class="uk-accordion-content">
                                    <p><a href='{!! url("view_payments_master") !!}'>Fee Payment by Students  Report</a></p>
                                    <p><a href='{!! url("finance/reports/programs") !!}'>Fee Payment by Class Report</a></p>
                                      
                                   <p><a href='{!! url("/owing_paid") !!}'>Fees Owings By Students Reports</a></p>
                                     <p><a href='{!! url("/finance/reports/owing") !!}'>Fees Owings By Class Reports</a></p>
                                ...
                                <div class="uk-accordion-content">
                                     <p><a href='{!! url("finance/reports/cummulative") !!}'> Fees Cummulative Reports by Classes</a></p>
                           ...
                           <li data-uk-dropdown class="uk-hidden-small">
                               ...
                               <div class="uk-dropdown uk-dropdown-scrollable">
                                   <ul class="uk-nav uk-nav-dropdown">
                                       ...
                                       <li><a href='{!! url("pay_fees") !!}'>Pay Fees</a></li>
                                       <li><a href='{!! url("/print/receipt") !!}'>Print Fee Receipt</a></li>
                                       <li><a href='{!! url("/finance/bills/single") !!}'>Print Single  Bill</a></li>
                              
                                      <li><a href='{!! url("/finance/reports/fees/") !!}'>Print Bulk  Bills</a></li>
