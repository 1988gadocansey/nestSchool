...
<div style="" class="">
   ...
   <a href="{{url('/students')}}" ><i   title="refresh this page" class="uk-icon-refresh uk-icon-medium "></i></a>
                ...
                <div class="uk-grid" data-uk-grid-margin="">
                      ...
                      <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                              ...
                                              {!!  Form::select('forms', array( '1'=>'Form 1s','2' => 'Form 2s', '3' => 'Form 3s','Alumni'=>'Alumni' ), null, ['placeholder' => 'select forms','id'=>'parent','class'=>'md-input parent'],old("form","")); !!}
                    ...
                    <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                              ...
                                              {!!  Form::select('fee_status', array( 'owing'=>'Owing fees','paid' => 'Not Owing fees',''=>'View All'  ), null, ['placeholder' => 'select fee payment status','id'=>'parent','class'=>'md-input parent'],old("fee_status","")); !!}
