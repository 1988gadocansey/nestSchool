                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            {!!   Form::select('combination',$combination,old('combination',''),array('placeholder'=>'Select subject combinations', "class"=>"md-input","v-model"=>"combination","v-form-ctrl"=>"","v-select"=>"combination"))  !!}
                 ...
                 <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                 <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_twitter">INDEX N<u>0</u> :</label><input type="text" name="indexno" class="md-input"   disabled="" v-model="indexno"  v-form-ctrl   ><span class="md-input-bar"></span></div>
                                             </div>
                                </div>
