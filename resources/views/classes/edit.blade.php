...
<div class="uk-width-xLarge-1-10">
    <div class="md-card">
        <div class="md-card-content" style="">
             ...
             <form  action="{{ url('/classes/edit')}}"  id="formn" accept-charset="utf-8" method="POST" name="applicationForm"  v-form>
                      ...
                      <p>&nbsp;</p>
                         <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                <p class="uk-text-danger uk-text-small"  v-if="applicationForm.teacher.$error.required" >Teacher is required</p>
            ...
            <div class="  uk-text-right">
                <input type="submit" value="Update"  v-if="applicationForm.$valid"   class="md-btn  update md-btn-success uk-margin-small-top">
