            ...
            <form    id="form" accept-charset="utf-8" method="POST" name="applicationForm"  v-form>
                ...
                <div class="parsley-row">
                    <div class="uk-input-group">
                        ...
                        <p></p>
                                             {!!  Form::select('type', array('WASSCE'=>'WASSCE','GRE'=>'GRE','DBS' => 'DBS' ,'JHS'=>'JHS','PRIMARY'=>'PRIMARY'), null, ['placeholder' => 'Select category','id'=>'parent','class'=>'md-input','required'=>'required','v-model'=>'type','v-form-ctrl'=>'','v-select'=>'','style'=>'width:200px'],old("type","")); !!}
