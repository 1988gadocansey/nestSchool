...
<div style="text-align: center;display: none" class="uk-alert uk-alert-success" data-uk-alert="">
                    ...
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                ( $class ), 
                                  old("classs",""),
                                    ['class' => 'md-input parent selects','id'=>"parent", 'required'=>'' ,'placeholder'=>'select class'] )  !!}
                         ...
                         <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                ( $year ), 
                                  old("year",""),
                                    ['class' => 'md-input parent selects','id'=>"parent", 'required'=>'' ,'placeholder'=>'select academic year'] )  !!}
                         ...
                         <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                {!!  Form::select('term', array('1'=>'1st Term','2'=>'2nd Term','3'=>'3rd Term' ), null, ['placeholder' => 'select term', 'required'=>'' , 'class'=>'md-input selects parent','id'=>"parent"],old("term","")); !!}
                         ...
                         <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">                            
                                <input type="text" style=" "   name="search"  class="md-input" placeholder="search student by index number">
                            </div>
                        </div>
 ...
 <div class="uk-width-xLarge-1-1">
   ...
   <div class="uk-overflow-container" id='print'>
       <center><h4 class="heading_c">BROADSHEET FOR {{$className}} {{$years}} ACADEMIC YEAR - TERM {{$term}}</h4></center>
       <hr>
      ...
      <tbody>
            ...
            <?php
               ...
               for($i=0;$i<count($course);$i++){  
                                        ...
                                        print_r("<td>".  round(@$sys->getCourseGrade($course[$i],$years,$term,$a))."% - ".@$sys->getGradeScore(@$sys->getCourseGrade($course[$i],$years,$term,$a),'PRIMARY')."</td>");
