...
@endif
 ...
 <div class="uk-width-xLarge-1-1">
    <div class="md-card">
        <div class="md-card-content">
               <form  action="{{url('/system/registration/batch/process')}}"  method="post" accept-charset="utf-8" name="applicationForm"  v-form >
                   {!!  csrf_field()  !!}
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                (['' => 'Select Class'] +$level ), 
                                  old("level",""),
                                    ["required"=>"required",'class' => 'md-input parent level','id'=>"parent" ,'v-model'=>'level','v-form-ctrl'=>'','v-select'=>''] )  !!}
                                 <p class="uk-text-danger uk-text-small"  v-if="applicationForm.level.$error.required" >Class is required</p>
                        ...
                        <div class="uk-width-medium-1-5">
                            ...
                            <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                   <button  v-show="applicationForm.$valid"  class="md-btn   md-btn-small md-btn-success uk-margin-small-top actionm" type="submit">Register</button>
