                ...
                <input type="hidden" name="_token" value="{!! csrf_token() !!}"> 
                   <div class="uk-grid" data-uk-grid-margin="">
                       ...
                       <div class="uk-form-row">
                                <div class="uk-grid">
                                       <div class="uk-width-medium-1-2">
                                        ...
                                        <p></p>
                     {!!  Form::select('term', array('1'=>'1st term','2'=>'2nd term','3' => '3rd term'), null, ['placeholder' => 'select term','required'=>'required',"v-model"=>"term","v-form-ctrl"=>"",'class'=>'md-input term'],old("semester","")); !!}
                                  <p class="uk-text-danger uk-text-small"  v-if="applicationForm.term.$error.required" >Term is required</p>
                     ...
                     {!! Form::select('year', 
                                ($years ), 
                                  old("year",""),
                                    ['class' => 'md-input year','required'=>"required",'placeholder'=>'select year',"v-model"=>"year","v-form-ctrl"=>"",] )  !!}
                    ...
                    UIkit.modal.confirm("Are you sure you want to allocate   " + subject + " to " + staff
                            ...
                            modal = UIkit.modal.blockUI("<div class='uk-text-center'>Ok allocating " + subject + " to " + staff + " <br/><img class='uk-thumbnail uk-margin-top' src='{!! url('public/assets/img/spinners/spinner.gif')  !!}' /></div>");
                                    ...
                                    $.ajax({
                                            ...
                                            data: {  staff:staff, subject:subject,classs:classs,year:year,term:term }, //your form data to post goes 
                                            dataType: "json",
                                    }). done(function(data){
