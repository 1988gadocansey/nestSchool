         ...
         <center><span class="uk-text-success uk-text-bold">{!! $mark->total()!!} Record(s)</span></center>
               ...
               <thead>
                 <tr>
                     ...
                     <th style="text-align:">SBA</th>
                      <th style="display:none">Class Work2</th>
                    <th style="display:none">Class Work3</th>
                     <th style="display:none">HomeWork1</th>
                     <th style="display:none">HomeWork2</th>
                     <th style="display:none">Class Test</th>
                     <th style="display:none">Class Test2</th>
                     <th style="display:none">Project 1</th>
                     <th style=" display:none">Project 2</th>
                     <th style="text-align:center;">SBA(50%)</th>
                     <th style="text-align:">Exam Score</th>
                     <th style="text-align:">Exam Score(50%)</th>
      ...
      <tbody>
                                       ...
                                       <?php $count++;?>
                                        ...
                                        <tr align="">
                                            ...
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="cw2[]" maxlength="4" class="marks" type="text" value="{{@$row->cw2}}"/></td>
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="cw3[]" maxlength="4" class="marks" type="text" value="{{@$row->cw3}}"/></td>
                                            
                                            <td style="display:none"><input style="text-align: center;width:87px;"  name="hw1[]" maxlength="4" class="marks" type="text" value="{{@$row->hw1}}"/></td>
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="hw2[]" maxlength="4" class="marks" type="text" value="{{@$row->hw2}}"/></td>
                                            <td style="display:none" ><input style="text-align: center;width:87px;" name="ctest1[]" maxlength="4" class="marks" type="text" value="{{@$row->ctest1}}"/></td>
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="ctest2[]" maxlength="4" class="marks" type="text" value="{{@$row->ctest2}}"/></td>
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="project1[]" maxlength="4" class="marks" type="text" value="{{@$row->project1}}"/></td>
                                            <td style="display:none"><input style="text-align: center;width:87px;" name="project2[]" maxlength="4" class="marks" type="text" value="{{@$row->project2}}"/></td>
                                            
                                            <td style="text-align: center">{{(@$row->cw1+$row->cw2+$row->cw3+$row->ctest1 + $row->ctest2+$row->hw1+$row->hw2+$row->project1+$row->project2)*0.5}}</td>
                                          
                                            <td><input style="text-align: center;width:87px"name="exam[]"class="marks" maxlength="4" type="text" value="{{@$row->exam}}"/></td>
                                             <td style="text-align: center">{{@$row->exam * 0.5}}</td>
...
<script>
       ...
       UIkit.modal.alert('Please wait saving marks...');
