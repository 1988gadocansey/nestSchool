        ...
        <td valign="top"><div align="center">
            <table width="98%" border="0" cellpadding="1" cellspacing="1" >
              <tr bgcolor="#F7F0DB" class="deco">
                <td width="49"><strong>Worker</strong></td>
                <td width="114"><strong>Date</strong></td>
                <td width="68"><strong>Student ID</strong></td>
                <td width="218"><strong>Name</strong></td>
                <td width="50"><strong>Class</strong></td>
                <td width="131"><strong>Type</strong></td>
                <td> <strong>B/F(GH&cent;) </strong></td>
                <td><strong>Change (GH&cent;) </strong></td>
                <td width="78"><strong> Balance (GH&cent;) </strong></td>
                </tr>
              <?php 
//include 'connect.php';
...
if($na=="ALL"){$na=""; $inse='';}else {$inse=" and feeadjustment.classes like '%$na%' ";}
...
//$it like '%$search%'
 ...
 $query="SELECT * ,students.id as id,feeadjustment.id as fid FROM students,feeadjustment where  students.id=feeadjustment.stuId $inse ";		  

if($search){$query.=" and $it like '%$search%' ";}
if($date1 and !$date2){$query.="and feeadjustment.dates ='$date1'";}elseif($date1 and $date2){$query.="and feeadjustment.dates >='$date1'";}
if($date2){$query.="and feeadjustment.dates <='$date2'";}
$show="&search=$search&date1=$date1&date2=$date2&it=$it";
$query=$query." ORDER BY  feeadjustment.id DESC";
...
?>
              <tr bordercolor="#AED7FF"  bgcolor="<?php echo (((++$AltColors1) % 2) == 0) ? "#F7F0DB" : "#FFFFFF"; ?>" onmouseout="this.style.backgroundColor = ''" onmouseover="this.style.backgroundColor = '#AED7FF'" >
                ...
                <td width="93" ><?php echo $r[oldbalance];?></td>
                <td width="89" ><?php  echo  number_format($r[change], 2, '.', ',');?></td>
