              ...
              <hr/>
                <table width="696" height="100" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"  class="sortable">
                  <thead style="background-color:#CCCCCC">
                    <tr>
                      <td height="22" colspan="2" bgcolor="#FFFFFF"><div align="left"><?php if($_SESSION['t']=='Boarding'){echo "Boarding House Bill";}else {echo "Academic Bill";}?></div></td>
                      </tr>
                    <tr>
                      <td  width="500" height="22">Description</td>
                      <td width="189" ><div align="center">Debt</div></td>
                      </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr bordercolor="#AED7FF"  bgcolor="<?php echo (((++$AltColors1) % 2) == 0) ? "#F7F0DB" : "#FFFFFF"; ?>"  >
                      <td  >Arrears From Last Term
                        <ae></td>
                      <td ><div align="center"><?php if($_SESSION['t']=='Boarding'){ echo $t['boardOutstanding']; $total=$t['boardOutstanding']; } else{echo $t['outstanding']; $total=$t['outstanding'];} ?>&nbsp;</div></td>
                      </tr><?php 
                ...
                <table width="697" height="100" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"  class="sortable">
                  <thead style="background-color:#CCCCCC">
                    ...
                    <tr>
                      <td  width="479" height="22">Description</td>
                      <td width="135" ><div align="center">Debt</div></td>
                      <td width="41" >&nbsp;</td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr bordercolor="#AED7FF"  bgcolor="<?php echo (((++$AltColors1) % 2) == 0) ? "#F7F0DB" : "#FFFFFF"; ?>"  >
                      <td  >Arrears From Last Term
                        <ae></td>
                      <td colspan="2" ><div align="center"><?php echo $t['ptaOutstanding']; $total=$t['ptaOutstanding'];?>&nbsp;</div></td>
                      </tr>
                    ...
                    <tr bgcolor="#CCCCCC"  >
                      ...
                      <td colspan="2" ><div align="center" class="style12"><strong><?php $thetotal +=$total; echo number_format($total, 2, '.', ',') ?></strong></div></td>
                      </tr>
                  </tbody>
                  <tfoot>
                  </tfoot>
...
<table width="697" height="100" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF"  class="sortable">
                ...
                <table width="687" height="12" border="0">
                  ...
                  <tr>
                    ...
                    <td colspan="2"><span class="sortable"><?php echo convert($thetotal);  ?></span></td>
                  </tr>
                </table>
                <hr/>
