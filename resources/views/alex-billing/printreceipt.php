    ...
    <td><table width="200" border="0">
        <tr>
          <td   style="border:dashed; text-align: left;"><table width="738" height="451" border="0" cellspacing="1">
            <tr>
              <td colspan="4"><table width="695" height="139" border="0">
                    <tr>
                      <td width="167" rowspan="3"><div align="right"><img src="images/crest.jpg" alt="crest" width="83" height="94" /></div></td>
                      <td width="515" height="33"><div align="center" class="style4">POPE JOHN SENOR HIGH SCHOOL &amp; MINOR SEMINARY</div></td>
                    </tr>
                    <tr>
                      <td><div align="center" class="style3">P.O. Box 370, Koforidua .Phone: 0342020265 . Website:www.pojossonline.net </div></td>
                    </tr>
                    <tr>
                      <td><div align="center" class="style4">Official Receipt</div>                        <div align="center"></div></td>
                    </tr>
                    </table>                  
                </td>
            </tr>
...
$output='';			  
  $ptaoutstanding=$_GET['ptaout'];
$outstanding=$_GET['out'];
$boardoutstanding=$_GET['boardout'];
...
$outputpta= " PTA: GH¢$ptapay ";
}

if($paybal>0 and $boardoutstanding>0){
$boardpay=$paybal;

$paybal=$paybal-$boardoutstanding;
if($paybal>0){$boardpay=$boardoutstanding;}
$boardbal=$boardoutstanding-$boardpay;
$outputboard= "Boarding Fee: GH¢$boardpay ";
}
if($paybal>0){
...
if($acapay>0){
$outputaca= " Academic Fee: GH¢$acapay ";
}else{$outputaca="";}
		echo $outputaca;
		if($outputaca){echo ", ";}
		echo $outputpta;
		if(($outputaca or $outputaca) and $outputboard){echo ", ";}
		...
		echo $outputboard; 	  
            ...
            <tr>
              ...
              <td style="border-bottom-style:dotted" colspan="3">GH¢ <?php  echo abs(number_format($_GET['ptaout']+$_GET['out']+$_GET['boardout']-$_GET['paid'], 2, '.', ','));?>&nbsp;
                  <strong>
                  <?php if($_GET['ptaout']+$_GET['out']+$_GET['boardout']-$_GET['paid']<0){echo "(Credit)";} ?></strong>
                  <?php }?></td>
            </tr>
            <tr>
              <td height="79">&nbsp;</td>
